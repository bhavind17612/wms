						...
						<div class="row" >
							...
							<div class="col-md-4">
								<div class="form-group">
								   <label for="firstName1">Item Number <span class="text-danger">*</span></label>
									<input type="text" class="form-control" data-validation-required-message="This field is required" placeholder="Item Number" name="item_number" value="{{old('item_number')}}"   >
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" data-validation-required-message="This field is required" placeholder="Order Qty" name="order_qty" value="{{ old('order_qty') }}"   >
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" data-validation-required-message="This field is required" placeholder="Line Status"   name="line_status" value="{{ old('line_status') }}"   >
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" data-validation-required-message="This field is required" placeholder="Type of Fulfillment"   name="line_type" value="{{ old('line_type') }}"   >
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" data-validation-required-message="This field is required" placeholder="Vendor Name"   name="vendor_po" value="{{ old('vendor_po') }}"   >
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" class="form-control" data-validation-required-message="This field is required" placeholder="Scheduled Pickup Date"   name="scheduled_pickup_date" value="{{ old('scheduled_pickup_date') }}"   >
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" class="form-control" data-validation-required-message="This field is required" placeholder=">Actual Pickup Date"   name="actual_pickup_date" value="{{ old('actual_pickup_date') }}"   >
