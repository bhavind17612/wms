...
<div class="pull-left">  <h3 class="box-title">Add New User</h3> </div>
...
<div class="row" >
	  ...
	  <div class="col-md-4">
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" data-validation-required-message="This field is required" placeholder="First Name"   name="first_name" value="{{ old('first_name') }}"   >
	  ...
	  <div class="col-md-4">
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" placeholder="Last Name" aria-invalid="true"  name="last_name"  value="{{ old('last_name') }}">
		...
		<div class="form-group">
		  ...
		  <input type="email" class="form-control" placeholder="Email address"   name="email" maxlength="50"  value="{{ old('email') }}">
		   @if($errors->has('email'))
